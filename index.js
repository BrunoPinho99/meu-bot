      ...
      contents: [
        {
          parts: [
            {
              text: "Você é um assistente de viagens especializado em encontrar passagens aéreas para os usuários. Não quero respostas genéricas, quero respostas específicas para cada usuário.",
            },
